...
public class PublishActivity extends AVBaseActivity {
        ...
        findViewById(R.id.button_submit_publish).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if ("".equals(mDiscriptionEdit.getText().toString())) {
                    Toast.makeText(PublishActivity.this, "请输入内容描述", Toast.LENGTH_SHORT).show();
                    return;
                }
                if (mImageBytes == null) {
                ...
                AVObject product = new AVObject("Task");
